...
pkgdatadir = $(datadir)/muncatascoin
pkgincludedir = $(includedir)/muncatascoin
pkglibdir = $(libdir)/muncatascoin
pkglibexecdir = $(libexecdir)/muncatascoin
...
ACLOCAL = ${SHELL} /muncatascoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /muncatascoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /muncatascoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /muncatascoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = muncatascoin-cli
BITCOIN_DAEMON_NAME = muncatascoind
BITCOIN_GUI_NAME = muncatascoin-qt
BITCOIN_TX_NAME = muncatascoin-tx
BITCOIN_WALLET_TOOL_NAME = muncatascoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The Muncatascoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Muncatascoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /muncatascoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = muncatascoin
PACKAGE_BUGREPORT = https://github.com/muncatascoin-project/muncatascoin/issues
PACKAGE_NAME = Muncatascoin Core
PACKAGE_STRING = Muncatascoin Core 0.18.1
PACKAGE_TARNAME = muncatascoin
PACKAGE_URL = https://muncatascoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /muncatascoin
abs_srcdir = /muncatascoin
abs_top_builddir = /muncatascoin
abs_top_srcdir = /muncatascoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /muncatascoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Muncatascoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Muncatascoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Muncatascoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Muncatascoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
