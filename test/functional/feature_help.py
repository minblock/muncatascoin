...
"""Verify that starting muncatascoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start muncatascoin with -h for help text")
        ...
        self.log.info("Start muncatascoin with -version for version information")
        ...
        self.log.info("Start muncatascoind with -fakearg to make sure it does not start")
