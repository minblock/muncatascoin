...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " muncatascoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  muncatascoin-tx [options] <hex-tx> [commands]  Update hex-encoded muncatascoin transaction\n" +
            "or:     muncatascoin-tx [options] -create [commands]   Create hex-encoded muncatascoin transaction\n" +
            "\n";
