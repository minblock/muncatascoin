...
#if defined(NDEBUG)
# error "Muncatascoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Muncatascoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("muncatascoin-scriptch");
