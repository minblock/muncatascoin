# Support for Output Descriptors in Muncatascoin Core

Since Muncatascoin Core v0.17, there is support for Output Descriptors. This is a
...
on Muncatascoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Muncatascoin Core wallets, a convenience function `combo` is
